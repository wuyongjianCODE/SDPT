...
_C.IMPROMPT=CN()
_C.IMPROMPT.map_module='mlp'#'conv'
_C.IMPROMPT.train_one_image_repeatly=False
_C.IMPROMPT.embed_768_to_lang=0 #{0,1,2}
_C.IMPROMPT.train_gt_1_per_class=0 #{-1,0,1}
_C.IMPROMPT.embed_768_to_lang_adaptively=False
_C.IMPROMPT.gvl=0 #{-1,0,1,2}
_C.IMPROMPT.input_way='first_gt_box'#'input_image_itself''real_gt'
...
_C.MAX_IMAGE_NUM_WHEN_USE_CAM=1000
_C.PLOT_GTBOX=False
_C.vpt_only=0
